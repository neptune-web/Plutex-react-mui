            ...
            <Grid item xs={12} sm={12} md={8} lg={8}>
              ...
              <Box mb={5}>
                <Typography className={classes.text21}>
                  ...
                  <a className={classes.text21 + ' ' + classes.yellowText}>LOREM IPSUM</a> safely is on Uniswap. There
                  are some centralized exchanges that have listed SHIB, but CEXs have a history of locking funds. If you
                  can, it is safer to trade on a decentralized exchange like Uniswap or 1inch.
                  <br />
                  <br />
                  <a className={classes.text21 + ' ' + classes.yellowText}>LOREM IPSUM</a> IS NOT AVAILABLE YET, BUT
